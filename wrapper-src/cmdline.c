/*
  ...
  gengetopt -i wrapper.ggo -F cmdline 
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'K':	/* .  */
          ...
          if (update_arg( (void *)&(args_info->key_port_arg), 
               &(args_info->key_port_orig), &(args_info->key_port_given),
              &(local_args_info.key_port_given), optarg, 0, "40020", ARG_INT,
              check_ambiguity, override, 0, 0,
              "key-port", 'K',
              additional_error))
            goto failure;
